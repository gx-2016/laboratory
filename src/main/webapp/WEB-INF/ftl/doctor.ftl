																					 ...
																					 <#list doctors as doctor>
																						 ...
																						 <div class="row-fluid" >
																								...
																								<div class="span3" >
																									<div >
																										<#if doctor.username??>
																											<a href="personalPage.do?userid=${doctor.userid}">
																								        • <b style="color:blue;font-size:18px;">${doctor.username}</b>
																								        </a>
																								        </#if>
																								        
																										<#if doctor.ondutydate??>
																										<nobr align="center">${doctor.ondutydate?string("yyyy")} -</nobr>
																										</#if>
																									</div>
																								</div>
