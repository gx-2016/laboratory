			...
			<div class="row-fluid">
				<div class="span12 rowWhite">
					...
					<div class="region region-breadcrumb">
						<div id="block-ua-theme-breadcrumbs"
							...
							<nav class="c-site-breadcrumb" aria-label="You are here">
								<ol class="c-site-breadcrumb__list">
									<li class="c-site-breadcrumb__list-item"><a href="home.do">首页</a>
									</li>
									<li class="c-site-breadcrumb__list-item"><a
										href="contest.do?contestType=校外"> 竞赛</a></li>
									<li class="c-site-breadcrumb__list-item"><span
										class="label label-success"> 竞赛队伍</span></li>
								</ol>
							</nav>
						</div>
					</div>
						...
						<article id="main-content" class="o-layout-main-article">
							<div class="region region-content">
								...
								<div class="news-events-feed__wrapper">
									<!--循环控制换行 队伍名称-->
									<#assign ddlname = "" > <#if contestTeamDDls??> <#list
									contestTeamDDls as ddl> <#if ddl.ddlname != ddlname> <#if
									ddl_index !=0> <br />
									<br />
									<br />
									<br /></#if>
									<h2 class="news-events-feed__title">
										<strong> <font color="#b38808"> <!--锚点--> <a
												id="${ddl.ddlname}_team"> </a> ${ddl.ddlname}
										</font>
										</strong>
									</h2>
									...
									<ul class="news-events-feed__content">
										...
										<div class="span5" align="right">
											<a href="#${ddl.ddlname}_contest" class="btn btn-info"> <font
												color="white">比赛介绍</font>
											</a>
										</div>
										<br />
										<br /> </#if> <#list ddl.users as user> <#if (user.remark ==
										'leader')>
										<span class="label label-warning">${user.remark}</span> <#if
										(user.sexid == '0')>
										<span class="label label-warning">♂</span> <#else>
										<span class="label label-warning">♀</span> </#if>
										<a href="personalPage.do?userid=${user.userid}"
											data-toggle="personmodal" data-uid="108">${user.username}</a>
										<br>
										<br> <#else>
										<span class="label label-info">${user.remark}</span> <#if
										(user.sexid == '0')>
										<span class="label label-info">♂</span> <#else>
										<span class="label label-info">♀</span> </#if>
										<a href="personalPage.do?userid=${user.userid}"
											data-toggle="personmodal" data-uid="89">${user.username}</a>&nbsp;&nbsp&nbsp;&nbsp;
										</#if> </#list> <#if ddl.ddlname != ddlname> <#assign ddlname
										= ddl.ddlname>
									</ul>
									</#if> </#list> </#if>
								</div>
							...
							<div class="news-events-feed__wrapper">
								<!--循环控制换行 队伍名称-->
								<#assign ddlname = "" > <#if teamContestInfos??> <#list
								teamContestInfos as teamContestInfo> <#if
								teamContestInfo.ddlname != ddlname> <#if teamContestInfo_index
								!=0> <br />
								<br /></#if>
								<h2 class="news-events-feed__title">
									<strong> <font color="#b38808"> <!--锚点--> <a
											id="${teamContestInfo.ddlname}_contest"></a>
											${teamContestInfo.ddlname}
									</font>
									</strong>
								</h2>
								...
								<ul class="news-events-feed__content">
									<div class="span7">
										<a href="#${teamContestInfo.ddlname}_team" class="btn btn-success">
									...
									<div class="row-fluid">
										<div class="span5">
											<p class="text-primary">
												<font size="4"><img style="width: 8%"
													src="Images/golden.png"> <strong>${teamContestInfo.ddlname}</strong></font>
											</p>
										</div>
										<div class="span7 media-text-right">
											<div class="row">
												<div class=" alert alert-info media-pull-right width-full"
													style="width: auto; margin-bottom: 5px; float: right;">
													${contest.contestdestination} @
													${contest.contesttime?string('yyyy-MM')}</div>
											</div>
											<#if contest.contestAward??>
											<div class="row" align="right">
												<div style="display: inline-block; margin-bottom: 10px;"
													class="alert alert-warning">
													<strong>${contest.contestAward}</strong>
												</div>
												<#else>
												<div class="row" align="right">
													<div style="display: inline-block; margin-bottom: 10px;"
													...
													</#if> <#if contest.contestRank??>
													<div style="display: inline-block; margin-bottom: 10px;"
														class="alert alert-success">
														<strong>${contest.contestRank}</strong>
													</div>
												</div>
												<#else>
												<div style="display: inline-block; margin-bottom: 10px;"
									...
									<br />
									 </#list> <#if teamContestInfo.ddlname != ddlname>
