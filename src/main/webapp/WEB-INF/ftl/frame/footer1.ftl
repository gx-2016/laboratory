  ...
  <div class="container"> 
	...
	<div class="row">
		<div class="span3 first">
			<h4 class="footer-title"><a href="home.do">Home</a></h4>
			<ul>
				<li><span title="Copyright Information">Copyright</span> <span class="hidden-phone hidden-tablet">& <span title="Website Disclaimer">Disclaimer</span></span></li>
				<li><span title="Privacy Statement">Privacy Statement</span></li>
				<li class="hidden-desktop"><span title="Website Disclaimer">Disclaimer</span></li>
				<li><span title="Website Feedback">Feedback</span></li>
			</ul>
		</div>
	...
	<div class="row">
		<div class="page-info span12" align="center">
			<table align="center">
				<tbody >
					<tr>
						<td style="font-size:15px;">南京邮电大学  ©copyright 2016 authored by 高翔、王峰、张洪成</td>
					</tr>
				</tbody>
			</table>
		</div>
