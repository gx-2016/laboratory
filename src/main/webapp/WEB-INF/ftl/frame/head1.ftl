<header>
  <div id="page-header" class="container"> 
    ...
    <div id="page-topbar" class="row topBar">
      <div class="span6"> <a href="/seek-light/" title="Nanjing University Of Posts And Telecommunications" class="btn-uoa-home"> <span class="btn-icon"></span> Seek Light </a> </div>
    ...
    <div class="row mainNav"> 
      <!--WFINC="filter(class=TagClass;directives=html~+menu-present)"-->
	<div class="span12">
		<nav>
