	                  ...
	                  <div class="row-fluid mbl">
								...
								<div class="span7 home-pod ">
									<div class="pod">
										...
										<hr>
										<div class="pod__content"><p style="margin:0px 0px 0px 20px;font-size:19px;line-height:1.5;font-family:楷体;text-indent:2em;">
								...
								<div class="span5 home-pod mln__ie7" >
									<div class="pod" >
										<div class="pod__title" >
											<h2 align="center" >
