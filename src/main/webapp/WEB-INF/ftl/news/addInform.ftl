                                 ...
                                 <div class="row" class="col-md-12" align ="center">
 	                            	<div class="col-md-12" >
 	                                	<div class="form-group"  >
 	                                    	...
 	                                    	<input type="text" class="form-control" id="informName" name= "informName" placeholder="通知标题" style="width:600px">
 	                                	
 	                                    	
 	                                		
 	                                		<label for="field-1" class="control-label">通知内容</label>  
                                  	   		<#include "../news/textEditor.ftl">
 	                                	
 	                                	</div>
	                                	<div align="center">
	                                		<input class="btn btn-primary " onclick="informsubmit()" value="提交"/>
	                                	</div>
 	                            	</div>
 	                            </div>
                             </div>
